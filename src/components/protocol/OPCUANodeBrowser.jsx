  ...
  const renderNode = (node, level = 0) => {
    ...
    return (
      <div key={node.nodeId} className="select-none">
        <button
          type="button"
          className={`flex items-center gap-2 p-2 hover:bg-muted/50 rounded cursor-pointer w-full text-left ${
            isSelected ? "bg-muted" : ""
          }`}
                ...
                <div className="space-y-2">
                  ...
                  {selectedNode.dataType && (
                    <div>
                      ...
                      <p className="text-sm">{selectedNode.dataType}</p>
                    </div>
                  )}
                  ...
                  {selectedNode.accessLevel && (
                    <div>
                      ...
                      <p className="text-sm">{selectedNode.accessLevel}</p>
                    </div>
                  )}
