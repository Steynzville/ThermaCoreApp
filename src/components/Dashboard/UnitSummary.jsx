import { AlertTriangle, Package, Wifi, WifiOff, Wrench, Zap } from "lucide-react";
...
const UnitSummary = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6">
      <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">Unit Summary</h3>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-lg font-bold text-blue-600 dark:text-blue-400">{totalUnits}</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Online</p>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Offline</p>
            <p className="text-lg font-bold text-gray-600 dark:text-gray-400">{offlineCount}</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-lg font-bold text-orange-600 dark:text-orange-400">{alertCount}</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-lg font-bold text-red-600 dark:text-red-400">{alarmCount}</p>
          </div>
        </div>
      </div>
    </div>
