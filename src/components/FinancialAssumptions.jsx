    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div className="p-6 space-y-6">
          <div>
            <label
              htmlFor="costOfElectricityPerKwh"
              className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"
            >
              Cost of electricity per kWh ($)
            </label>
            <input
              id="costOfElectricityPerKwh"
              type="number"
              step="0.01"
              min="0"
              value={assumptions.electricityCost !== undefined ? assumptions.electricityCost : ""}
              onChange={(e) =>
          ...
          <div>
            ...
            <input
              ...
              step="0.01"
              min="0"
              value={assumptions.rebate !== undefined ? assumptions.rebate : ""}
          ...
          <div>
            <label
              htmlFor="feedinTariffPerKwh"
              className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"
            >
              Feed-in tariff per kWh ($)
            </label>
            <input
              id="feedinTariffPerKwh"
              type="number"
              step="0.01"
              min="0"
              value={assumptions.feedInTariff !== undefined ? assumptions.feedInTariff : ""}
              onChange={(e) =>
