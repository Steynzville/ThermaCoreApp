...
def test_permission_required_decorator(app):
    ...
    with app.test_request_context():
        with patch("app.middleware.authorization.verify_jwt_in_request") as mock_verify, \
             patch("app.middleware.authorization.get_current_user_id", return_value=(None, False)), \
    ...
    with app.test_request_context():
        with patch("app.middleware.authorization.verify_jwt_in_request"), \
             patch("app.middleware.authorization.get_current_user_id", return_value=(10, True)), \
