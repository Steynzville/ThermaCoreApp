...
from app.models import PermissionEnum, Role, User
...
class TestEnhancedPermissionHandling:
    ...
    def test_role_has_permission_type_error_on_invalid_type(self, client, db_session):
        ...
        with pytest.raises(
            TypeError,
            match="Permission must be a string or PermissionEnum",
        ):
    ...
    def test_remote_control_permission_for_all_roles(self, client, db_session):
        ...
        from app.models import PermissionEnum, RoleEnum
        ...
        roles_with_remote_control = [(admin_role, "Admin"), (operator_role, "Operator")]
