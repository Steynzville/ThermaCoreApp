...
class TestSecureLogger:
    ...
    def test_sanitize_authorization_header(self):
        ...
        # This is test data for token redaction testing - not a real secret
        message = (
            "Request with authorization=Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9"
        )
        sanitized = SecureLogger.sanitize_log_message(message)
    ...
    def test_sanitize_dict_with_token(self):
        ...
        data = {"user_id": 123, "token": "abc123xyz", "expires": 3600}
        sanitized = SecureLogger.sanitize_dict(data)
    ...
    def test_sanitize_dict_with_api_key(self):
        ...
        data = {"api_key": "my_secret_key", "endpoint": "/api/v1/users"}
        sanitized = SecureLogger.sanitize_dict(data)
    ...
    def test_sanitize_dict_case_insensitive(self):
        ...
        data = {"PASSWORD": "secret", "Token": "abc123", "API_KEY": "xyz789"}
        sanitized = SecureLogger.sanitize_dict(data)
