...
class TestProductionScenarios:
    ...
    def test_opcua_optional_in_production(self):
        ...
        with patch('app.utils.environment.is_production_environment', return_value=True):
            result = initialize_service(
                mock_service, "OPC UA client", mock_app, mock_logger,
    ...
    def test_disabled_service_never_raises(self):
        ...
        service_manager.register_service(manager_name, ServiceType.REQUIRED, enabled=False)
    ...
    def test_service_manager_tracks_service_states(self):
        ...
        manager.register_service('service_disabled', ServiceType.REQUIRED, enabled=False)
...
class TestServiceManagerHealthReporting:
    ...
    def test_health_healthy_when_optional_disabled(self):
        ...
        manager.register_service('optional_disabled', ServiceType.OPTIONAL, enabled=False)
...
class TestBackwardsCompatibility:
    ...
    def test_old_initialize_pattern_still_works(self):
        ...
        result = initialize_service(
            mock_service, "legacy service", mock_app, mock_logger,
            'init_app', required=True
        )
