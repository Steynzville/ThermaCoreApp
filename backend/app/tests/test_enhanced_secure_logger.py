...
class TestEnhancedDictSanitization:
    ...
    def test_sanitize_dict_with_ssn(self):
        ...
        data = {"name": "John Doe", "ssn": "123-45-6789", "email": "john@example.com"}
    ...
    def test_sanitize_dict_with_credit_card(self):
        ...
        data = {"user_id": 123, "credit_card": "4532-1234-5678-9010", "cvv": "123"}
        sanitized = SecureLogger.sanitize_dict(data)
    ...
    def test_sanitize_dict_with_session(self):
        ...
        data = {"session": "abc123", "session_id": "xyz789", "sessionid": "def456"}
        sanitized = SecureLogger.sanitize_dict(data)
    ...
    def test_sanitize_dict_with_credentials(self):
        ...
        data = {"username": "admin", "credentials": "admin:password123"}
        sanitized = SecureLogger.sanitize_dict(data)
    ...
    def test_sanitize_nested_dict_with_pii(self):
        ...
        data = {
            "user": {
                "name": "John Doe",
                "ssn": "123-45-6789",
                "payment": {"credit_card": "4532123456789010", "cvv": "123"},
            }
        }
        sanitized = SecureLogger.sanitize_dict(data)
