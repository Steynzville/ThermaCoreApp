...
class TestUnitsAPI:
    ...
    def test_get_units_success(self, client):
        ...
        response = client.get(
            "/api/v1/units", headers={"Authorization": f"Bearer {token}"}
        )
    ...
    def test_get_unit_by_id(self, client):
        ...
        response = client.get(
            "/api/v1/units/TEST001", headers={"Authorization": f"Bearer {token}"}
        )
    ...
    def test_get_unit_not_found(self, client):
        ...
        response = client.get(
            "/api/v1/units/NONEXISTENT", headers={"Authorization": f"Bearer {token}"}
        )
    ...
    def test_delete_unit_success(self, client, db_session):
        ...
        response = client.delete(
            "/api/v1/units/DELETE_ME", headers={"Authorization": f"Bearer {token}"}
        )
    ...
    def test_get_unit_stats(self, client):
        ...
        response = client.get(
            "/api/v1/units/stats", headers={"Authorization": f"Bearer {token}"}
        )
