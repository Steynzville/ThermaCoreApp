    ...
    def test_get_roles_has_correct_structure(self, client):
        ...
        for role in roles:
            ...
            for permission in role["permissions"]:
                assert "id" in permission, f"Permission missing 'id' field: {permission}"
                assert "name" in permission, f"Permission missing 'name' field: {permission}"
                assert "description" in permission, f"Permission missing 'description' field: {permission}"
