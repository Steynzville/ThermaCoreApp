...
class TestValidationDecorator:
    ...
    def test_empty_json_request(self, client):
        ...
        response = client.post(
            "/test/validate", data="", headers={"Content-Type": "application/json"}
        )
        ...
        assert "json" in error_msg and ("invalid" in error_msg or "valid" in error_msg)
    ...
    def test_null_json_request(self, client):
        ...
        response = client.post(
            "/test/validate", data="null", headers={"Content-Type": "application/json"}
        )
