...
class TestSanitizeFunction:
    ...
    def test_sanitize_dict(self):
        ...
        expected = {"key1": "valuewithnewlines", "key2": "clean", "key3": "tabshere"}
        assert sanitize(input_dict) == expected

    def test_sanitize_nested_dict(self):
        """Test sanitizing nested dictionary."""
        input_dict = {"outer": {"inner": "value\nwith\nnewlines", "clean": "no issues"}}
        expected = {"outer": {"inner": "valuewithnewlines", "clean": "no issues"}}
        assert sanitize(input_dict) == expected
    ...
    def test_sanitize_removes_all_control_chars(self):
        ...
        input_str = (
            "test\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0fvalue"
        )
