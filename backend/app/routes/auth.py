...
"""
        ...
        logger.info(f"Connecting to SMTP server {smtp_host}:{smtp_port} with timeout 30s...")
        ...
        logger.error("❌ Connection timeout - SMTP server unreachable")
        return False, "Connection timeout - SMTP server unreachable"
