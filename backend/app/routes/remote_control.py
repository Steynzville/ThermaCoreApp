...
@remote_control_bp.route(
    "/remote-control/units/<string:unit_id>/power", methods=["POST"]
)
@jwt_required()
...
@remote_control_bp.route(
    "/remote-control/units/<string:unit_id>/water-production", methods=["POST"]
)
@jwt_required()
@permission_required("remote_control")
...
@remote_control_bp.route(
    "/remote-control/units/<string:unit_id>/status", methods=["GET"]
)
@jwt_required()
