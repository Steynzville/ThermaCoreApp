...
class AuthenticationException(ThermaCoreException):
    ...
    def __init__(self, message: str = "Authentication failed", **kwargs):
        super().__init__(
            message, error_type="authentication_error", status_code=401, **kwargs
        )
...
class AuthorizationException(ThermaCoreException):
    ...
    def __init__(self, message: str = "Access denied", **kwargs):
        super().__init__(
            message, error_type="permission_error", status_code=403, **kwargs
        )
...
class ResourceNotFoundException(ResourceException):
    ...
    def __init__(self, resource_type: str, resource_id: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            message, error_type="not_found_error", status_code=404, **kwargs
        )
...
class ValidationException(ThermaCoreException):
    ...
    def __init__(self, message: str, field: Optional[str] = None, **kwargs):
        super().__init__(
            message, error_type="validation_error", status_code=400, **kwargs
        )
        if field:
...
class InvalidDataException(ValidationException):
    ...
    def __init__(
        self, field: str, value: Any = None, reason: Optional[str] = None, **kwargs
    ):
        if reason:
...
class DatabaseException(ThermaCoreException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            message, error_type="database_error", status_code=500, **kwargs
        )
...
class ConfigurationException(ThermaCoreException):
    ...
    def __init__(self, message: str, config_key: Optional[str] = None, **kwargs):
        super().__init__(
            message, error_type="configuration_error", status_code=500, **kwargs
        )
        if config_key:
...
class SensorOutOfRangeException(SensorException):
    ...
    def __init__(
        self, sensor_id: str, value: float, min_value: float, max_value: float, **kwargs
    ):
        message = (
        ...
        super().__init__(
            sensor_id, message, error_type="validation_error", status_code=400, **kwargs
        )
        self.details.update(
            {
                "sensor_id": sensor_id,
