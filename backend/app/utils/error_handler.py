...
class SecurityAwareErrorHandler:
    ...
    def handle_thermacore_exception(exception) -> Tuple[Any, int]:
        ...
        log_message = f"Domain exception [{request_id}] {exception.__class__.__name__} in {exception.context}: {str(exception)}"
        ...
        response_data = {
            ...
            "error": {
                ...
                "details": {"context": exception.context, "correlation_id": request_id},
            },
            "request_id": request_id,
    ...
    def handle_service_error(
        ...
        generic_message = SecurityAwareErrorHandler.GENERIC_MESSAGES.get(
            error_type, SecurityAwareErrorHandler.GENERIC_MESSAGES["internal_error"]
        )
    ...
    def handle_mqtt_error(
        error: Exception, context: str = "MQTT operation"
    ) -> Tuple[Any, int]:
    ...
    @staticmethod
    def handle_opcua_error(
        error: Exception, context: str = "OPC UA operation"
    ) -> Tuple[Any, int]:
    ...
    def handle_websocket_error(
        error: Exception, context: str = "WebSocket operation"
    ) -> Tuple[Any, int]:
    ...
    def handle_database_error(
        error: Exception, context: str = "Database operation"
    ) -> Tuple[Any, int]:
    ...
    def handle_validation_error(
        error: Exception, context: str = "Validation"
    ) -> Tuple[Any, int]:
    ...
    def handle_input_validation_error(
        field_name: str, error_message: str, context: str = "Input validation"
    ) -> Tuple[Any, int]:
    ...
    @staticmethod
    def validate_and_handle_input(
        value: Any, context: str = "input"
    ...
    def handle_permission_error(
        error: Exception, context: str = "Permission check"
    ) -> Tuple[Any, int]:
    ...
    def handle_value_error(
        error: ValueError,
        context: str = "Request parameter validation",
        user_message: str = "Invalid request parameter.",
    ) -> Tuple[Any, int]:
    ...
    def handle_not_found_error(context: str = "Resource") -> Tuple[Any, int]:
        ...
        request_id = getattr(g, "request_id", str(uuid.uuid4()))
        logger.warning(
            f"{context} not found [{request_id}]",
            extra={
                "request_id": request_id,
    ...
    def handle_service_unavailable(service_name: str) -> Tuple[Any, int]:
        ...
        request_id = getattr(g, "request_id", str(uuid.uuid4()))
        logger.warning(
            f"{service_name} service not available [{request_id}]",
            extra={
                "request_id": request_id,
    ...
    def register_error_handlers(app):
        ...
        def _build_jwt_error_response(
            error_message: str, log_message: str, status_code: int = 422
        ):
            """Build standardized JWT error response with request_id and timestamp.
            ...
            if "flask-jwt-extended" in app.extensions:
                ...
                def expired_token_callback(jwt_header, jwt_payload):
                    ...
                    return _build_jwt_error_response(
                        "Token has expired", "Expired JWT token [{request_id}]"
                    )
                ...
                def invalid_token_callback(error_string):
                    ...
                    return _build_jwt_error_response(
                        error_string,
                        "Invalid JWT token [{request_id}]: " + error_string,
                    )
                ...
                def unauthorized_callback(error_string):
                    ...
                    return _build_jwt_error_response(
                        error_string,
                        "Missing JWT token [{request_id}]: " + error_string,
                        status_code=401,
                    )
                ...
                def revoked_token_callback(jwt_header, jwt_payload):
                    ...
                    return _build_jwt_error_response(
                        "Token has been revoked", "Revoked JWT token [{request_id}]"
                    )
