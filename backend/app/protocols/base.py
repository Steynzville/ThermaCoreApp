...
class ProtocolStatus:
    ...
    def to_dict(self) -> dict:
        ...
        data["is_heartbeat_stale"] = is_heartbeat_stale(
            self.last_heartbeat, self.heartbeat_timeout_seconds
        )
        data["time_since_last_heartbeat"] = get_time_since_last_heartbeat(
            self.last_heartbeat
        )
    ...
    def record_error(
        self, error_code: str, error_message: str = None, context: Dict[str, Any] = None
    ) -> None:
