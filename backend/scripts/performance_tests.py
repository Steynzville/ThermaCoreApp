...
class ThermaCoreSCADAUser(HttpUser):
    ...
    def get_units_with_pagination(self):
        ...
        self.client.get(
            f"/api/v1/units?page={page}&per_page={per_page}", headers=self.headers
        )
    ...
    def get_unit_readings(self):
        ...
        self.client.get(
            f"/api/v1/units/{unit_id}/readings?hours={hours}", headers=self.headers
        )
    ...
    def update_unit_status(self):
        ...
        self.client.patch(
            f"/api/v1/units/{unit_id}/status", json=status_data, headers=self.headers
        )
...
class ThermaCoreCRUDUser(HttpUser):
    ...
    def create_unit(self):
        ...
        response = self.client.post(
            "/api/v1/units", json=unit_data, headers=self.headers
        )
    ...
    def update_random_unit(self):
        ...
        if self.created_units:
            ...
            self.client.put(
                f"/api/v1/units/{unit_id}", json=update_data, headers=self.headers
            )
...
class ThermaCoreSensorDataUser(HttpUser):
    ...
    def create_sensor(self):
        ...
        self.client.post(
            f"/api/v1/units/{unit_id}/sensors", json=sensor_data, headers=self.headers
        )
