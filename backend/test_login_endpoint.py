...
def main():
    ...
    # Parse arguments
    if len(sys.argv) < 2:
        print("Usage: python test_login_endpoint.py [backend_url] [username] [password]")
        print("\nExamples:")
        print("  python test_login_endpoint.py http://localhost:5000 admin admin123")
        print("  python test_login_endpoint.py https://thermacoreapp.onrender.com admin admin123")
        sys.exit(1)
