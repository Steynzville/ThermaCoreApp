...
def demonstrate_domain_exceptions():
    ...
    try:
        ...
        examples = [
            ...
            # Configuration error
            ConfigurationException(
                "Missing MQTT broker configuration", "MQTT_BROKER_HOST"
            ),
        ]
...
def demonstrate_error_handling():
    ...
    try:
        ...
        response1 = simulate_error_response(
            validation_error, validation_error.error_type, validation_error.status_code
        )
        ...
        response2 = simulate_error_response(
            auth_error, auth_error.error_type, auth_error.status_code
        )
...
def demonstrate_logging_features():
    ...
    print(
        "   - WARNING level: validation_error, authentication_error, permission_error"
    )
...
def main():
    ...
    if passed == total:
        ...
        print(
            "The logging refinement and domain exception handling improvements are working correctly."
        )
    else:
